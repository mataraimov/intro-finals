...
def score_dis(scoree, highscoree):
    if is_going:
        ...
        highscoresur = game_font2.render(f'High score: {highscoree}', True, (255, 255, 255))
        highscore_rect = highscoresur.get_rect(center=(450, 75))
        screen.blit(highscoresur, highscore_rect)

        highscoresurs = game_font2.render(f'PRESS SPACE TO PLAY AGAIN!', True, (255, 255, 255))
        ...
        highscoresurse = game_font2.render(f'PRESS SPACE TO GO ON NEXT LEVEL!', True, (255, 255, 255))
...
res_blocks = [pygame.Rect(10 + 80*i, 10 + 40*j, 80, 40) for i in range(11) for j in range(4)]
